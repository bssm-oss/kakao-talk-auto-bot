...
- **페르소나/말투 설정**: 내 이름, 직접 적은 예시, 방별 말투, 학습된 말투를 커스터마이징
- **자동 대화 요약**: 최근 대화를 자동으로 분석해 메모에 반영
- **강화된 로컬 그라운딩**: primary/compact/emergency 모든 프롬프트에서 페르소나, 말투, 방 메모, 최근 대화 맥락을 최대한 유지
